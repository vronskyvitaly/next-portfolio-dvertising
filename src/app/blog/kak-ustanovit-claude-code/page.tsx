...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: "Пошаговая инструкция для Mac, Windows и Linux. Без технических терминов.",
  },
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 py-16 sm:py-24">
          ...
          <header className="mb-12">
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Простая инструкция для тех, кто слышал про Claude Code, но не знает с чего
              начать. Никакого сложного языка — только шаги и результат.
            </p>
          </header>
          ...
          <article className="space-y-14 text-gray-300 leading-relaxed">
            ...
            <section>
              ...
              <p className="mb-4">
                Представьте, что у вас есть очень умный помощник, которому можно написать на
                русском: <em className="text-gray-200">«создай мне таблицу с данными»</em>,{" "}
                <em className="text-gray-200">«найди ошибку в этом коде»</em> или{" "}
                <em className="text-gray-200">«переименуй все файлы в папке по порядку»</em> —
                и он просто это сделает.
              </p>
              <p className="mb-4">
                Claude Code — это ИИ-помощник от Anthropic, который работает прямо в вашем
                компьютере через терминал (командную строку). В отличие от обычного чата в
                браузере, он видит ваши файлы и папки, может их редактировать, создавать
                новые, запускать программы.
              </p>
              <div
              ...
              >
                <p className="text-blue-200 font-medium leading-relaxed">
                  Вы просто пишете задачу на человеческом языке — Claude Code сам разбирается,
                  какие команды нужно выполнить, и делает это за вас.
                </p>
              </div>
            </section>
            ...
            {/* Что нужно */}
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">Что нужно перед установкой</h2>
            ...
            {/* Установка */}
            <section>
              <h2 className="text-2xl font-bold text-white mb-2">Установка — шаг за шагом</h2>
              <p className="text-gray-400 mb-6">Выберите свою операционную систему:</p>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-400 mb-3">
                  Откройте приложение <strong className="text-gray-200">Терминал</strong>{" "}
                  (найдите через Spotlight — ⌘+Пробел, напишите «Терминал»). Вставьте эту
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-400 mb-3">
                  Откройте <strong className="text-gray-200">PowerShell</strong> от имени
                  администратора (правая кнопка на меню Пуск → «Windows PowerShell
                  (администратор)»). Вставьте и нажмите Enter:
                </p>
                <div
                  className="p-4 rounded-xl font-mono text-sm text-green-300 overflow-x-auto"
                  style={{ background: "rgba(0,0,0,0.6)", border: "1px solid rgba(255,255,255,0.08)" }}
              ...
              >
                <p className="text-purple-200">
                  💡 После установки закройте терминал и откройте заново — чтобы изменения
                  вступили в силу.
                </p>
              </div>
            </section>
            ...
            {/* Первый запуск */}
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">Первый запуск</h2>
                ...
                {[
                  {
                    ...
                    desc: (
                      <>
                        ...
                        или просто перетащите папку на иконку терминала — он сам откроется в
                        нужном месте. Можно запустить и без папки — Claude Code будет работать
                  ...
                  },
                  {
                    ...
                    desc: (
                      <>
                        ...
                        и нажмите Enter. При первом запуске он попросит войти в аккаунт
                        Anthropic — следуйте инструкциям на экране.
                      </>
                    ),
                  },
                  {
            ...
            <section>
              ...
              <p className="mb-6">
                Просто пишите задачу в свободной форме. Вот несколько примеров того, что
                Claude Code умеет делать:
              </p>
              <div className="space-y-3">
                {[
                  {
                  ...
                  },
                  {
                    ...
                    result: "Находит баги, показывает что именно менять, спрашивает разрешения",
                  },
                  {
          ...
          >
            ...
            <p className="text-gray-400 mb-8 max-w-md mx-auto">
              Помогу настроить Claude Code под ваши задачи или автоматизировать бизнес-процессы
              с нуля.
            </p>
            <a
              href="https://t.me/vitalyvronsky"
