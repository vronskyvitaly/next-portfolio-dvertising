...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Автоматизация бизнеса и внедрение ИИ — Виталий Вронский",
    description:
      "Автоматизирую бизнес-процессы, создаю сайты и веб-приложения, внедряю ИИ в организации. Telegram-боты и автоматизация круглосуточно.",
    locale: "ru_RU",
  },
  twitter: {
    ...
    title: "Автоматизация бизнеса и внедрение ИИ — Виталий Вронский",
    description:
      "Автоматизирую бизнес-процессы, создаю сайты и веб-приложения, внедряю ИИ в организации.",
  },
  robots: {
    index: true,
    follow: true,
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description:
        "Автоматизация бизнес-процессов, разработка сайтов и веб-приложений, внедрение ИИ в организации, создание Telegram-ботов.",
      url: SITE_URL,
